...
public class AutoRecyclerView
    ...
    public void resetFootView() {
        mFootViews.clear();
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_loadmore_footer, this, false);
        mFootViews.add(view);
        if (mAdapter != null) {
            if (!(mAdapter instanceof WrapAdapter)) {
                mAdapter = new WrapAdapter(mHeaderViews, mFootViews, mAdapter);
    ...
    public void setAdapter(Adapter adapter) {
        if (mFootViews.isEmpty()) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.layout_loadmore_footer, this,
                    false);
            mFootViews.add(view);
        }
